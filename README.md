...
* Windows - Open the solution in Visual Studio 2019 or later with the **Desktop development with C++** workload installed. The **Linux development with C++** workload is recommended, but not required. You *must* build in x64 configuration (*not* AnyCPU which is the default). 
  
* Linux - (Tested with Ubuntu 18.04 and 20.04) Install dependencies, compile, run `make linux-x64`

* Mac - Install Xcode. To compile, run `make mac-universal`.
